...
| Nút K1 | GPIO 9 (pull-up nội) — chức năng chính |
| Nút K2 | RESET (EN pin) — khởi động lại thiết bị |
...
> **K2** (nút RESET): khởi động lại thiết bị ngay lập tức, bất kỳ lúc nào.
>
> **K1** (GPIO 9): tất cả các chức năng bên dưới.
